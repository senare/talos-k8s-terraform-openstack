...
provider "openstack" {
  ...
  project_domain_name = "${get_env("OS_PROJECT_DOMAIN_NAME", "no_def_project_domain_name")}"
  region = "${get_env("OS_REGION_NAME", "no_def_region")}"
  tenant_name = "${get_env("OS_TENANT_NAME", "no_def_tenent_name")}"
